...
public class Bolso extends Accesorio {
    ...
    public Bolso(String codigoArticulo, String nombre, float precio, String marca, String descripcion, String imagen, boolean activo, String estilo, boolean esPersonalizado, String tipoCierre, int capacidad) {
