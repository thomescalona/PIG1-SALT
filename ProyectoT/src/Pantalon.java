public class Pantalon extends Ropa {
    ...
    public Pantalon(String codigoArticulo, String nombre, float precio, String marca, String descripcion, String imagen, Material material, boolean activo, int talla, String color, String tipoCierre, boolean tieneBolsillo, String tipoPantalon) {
    ...
    public String toString() {
        return "¿Tiene bolsillo?: " + tieneBolsillo + ", Tipo de pantalón: " + tipoPantalon;
    }
